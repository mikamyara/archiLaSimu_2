...
ArchiCircuit::ArchiCircuit() {
    ...
    allRegisters.push_back(RA);  allRegisters.push_back(RB);   allRegisters.push_back(RC);  allRegisters.push_back(RD);
    allRegisters.push_back(OP);  allRegisters.push_back(CO);  allRegisters.push_back(RI);   allRegisters.push_back(RX);
    allRegisters.push_back(RE);  allRegisters.push_back(RAM);
...
ArchiCircuit::calcBus() {
    ...
    mBuses.resize(0);
    mBus1 = nullptr; mBus2 = nullptr; mBus3 = nullptr;
  ...
  mBus2 = new Bus(OP->mBus2Node,"Bus2",gArchiTheme.mBus2Color,gArchiTheme.mBusThickness);
    ...
    mBuses.push_back(mBus1);mBuses.push_back(mBus2);mBuses.push_back(mBus3);
